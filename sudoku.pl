...
% solucao verbosa, porem eficiente de resolver a tabela 9x9 de sudoku
...
sudoku([[A1,B1,C1,D1,E1,F1,G1,H1,I1],
    ...
    % garantir que todas as linhas contenham numeros diferentes entre si
    ...
    % garantir que todas as colunas contenham numeros diferentes entre si
    ...
    % adicionando a separacao dos quadrantes do sudoku
    % 1
